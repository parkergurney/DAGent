"""Public worker execution contract generated by the harness.

This is deliberately a narrow projection of a task. It contains the public
verification command and delivery expectations, never hidden verifier
configuration or evaluator material.
"""
