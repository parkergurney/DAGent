...
async def run_phase5_cell(*, package_dir: str | Path | None = None, graph: str,
    ...
    from orchestrator.harbor_runtime import run_from_files
...
def _phase5_main(argv: list[str]) -> int:
    ...
    parser = argparse.ArgumentParser(prog="orchestrator-experiment")
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(prog="orchestrator-report")
