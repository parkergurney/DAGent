...
Agent SDK sessions, both spoken through the same subprocess wire
...
single task outside the scheduler); worktree_pool.py is what the
scheduler itself uses for concurrent batches."""
