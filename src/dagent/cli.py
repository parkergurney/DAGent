...
from dagent.store import TERMINAL, append_event, connect, create_task, transition
from dagent.supervisor import always_escalate, invoke_supervisor
from dagent.worker import (
...
def main(argv=None) -> int:
    p = argparse.ArgumentParser(prog="dagent")
    sub = p.add_subparsers(dest="command", required=True)

    p_add = sub.add_parser("add-task", help="create a new task")
    p_add.add_argument("--db", default="data/dagent.db")
    ...
    p_answer.add_argument("--db", default="data/dagent.db")
